...
exit;
  ...
  echo -e 'by: CYBERSSH' >/usr/lib/telegram
  msg -bar
...
wget https://raw.githubusercontent.com/Cyber-ssh/pweb/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/pweb/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/pweb/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/pweb/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/pweb/main/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/Cyber-ssh/pweb/main/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "CYBERSSH" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy CYBERSSH\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/Cyber-ssh/pweb/main/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37mCYBERSSH\033[0m" | lolcat
echo ""
