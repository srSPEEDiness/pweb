...
wget https://raw.githubusercontent.com/CoutySSH/SSH-WEB/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/SSH-WEB/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/SSH-WEB/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/SSH-WEB/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/SSH-WEB/main/whatsapp.sh > /dev/null 2>&1
...
wget https://www.dropbox.com/s/uxwf0b84aexj8qf/gestorssh.zip > /dev/null 2>&1
