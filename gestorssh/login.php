...
<head>
    ...
    <title> VPS WEB V.31 | Login Expirado</title>
...
<br>
<br><br>
<center><b> © <script>document.write(new Date().getFullYear())</script> | <b>Direitos Reservados a</b> <i class="fa fa-linux"></i><a href="http://www.vipvps.tk/" target="_blank" class="text-info m-l-5"><b> VPS WEB V.31</b></a><b></b></center>
</section>
    </form>
...
<footer class="footer footer-static footer-light">
    <center><p class="clearfix blue-grey lighten-2 mb-0">
        <span class="center">
            ...
            <a class="text-bold-800 grey darken-2" href="http://www.vipvps.tk/" target="_blank"> VPS WEB V.31</a></span>
        </span>
