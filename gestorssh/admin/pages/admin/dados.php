...
<section id="multiple-column-form">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Alterar Informações do Painel (Atenção!)</h4> 
                </div>
                <div class="card-body">
						<form action="pages/admin/alterarNome.php" method="POST" role="form">
                        <div class="row">

                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-icon">Nome Atual</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="link-2"></i></span>
                                        <input type="text" disabled class="form-control" minlength="6" value="<?php $empresa = file_get_contents("../admin/pages/admin/empresa"); echo $empresa; ?>" required="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-2">
                                    <label class="form-label" for="first-name-icon">Novo Nome</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather='link-2'></i></span>
                                        <input type="text" name="nome_empresa" id="nome_empresa" minlength="5" placeholder="Digite o Novo Nome do Painel" class="form-control">
                                    </div>
                                </div>
                            </div>

                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-success me-1 waves-effect waves-float waves-light">Alterar</button>
                                <button type="reset" class="btn btn-danger waves-effect">Limpar</button>
                            </div>
