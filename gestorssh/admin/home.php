...
<head>
    ...
    <meta name="keywords" content="VPN <?php $empresa = file_get_contents("../admin/pages/admin/empresa"); echo $empresa; ?> 🚀, VPN, SSH, Gratis, Registrar">
    <meta name="author" content="Crazy">
    <meta name="msapplication-TileColor" content="#FFFFFF">
    <meta name="theme-color" content="#FFFFFF">
    <title><?php $empresa = file_get_contents("../admin/pages/admin/empresa"); echo $empresa; ?> PAINEL</title>
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="/admin/home.php"><span class="brand-logo">
                        ...
                        <h2 class="brand-text"><?php $empresa = file_get_contents("../admin/pages/admin/empresa"); echo $empresa; ?></h2>
                    </a></li>
        ...
        <center>
            <p class="clearfix blue-grey lighten-2 mb-0">
                <span class="center">
                    ...
                    <a class="text-bold-800 grey darken-2" href="index.php" target="_blank"><?php $empresa = file_get_contents("../admin/pages/admin/empresa"); echo $empresa; ?>🚀</a></span>
                </span>
            </p>
        </center>
    </footer>
