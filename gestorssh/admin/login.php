...
<head>
    ...
    <meta name="author" content="Couty SSH">
    <meta name="msapplication-TileColor" content="#1e88e5">
    <meta name="theme-color" content="#1e88e5">
    <title> V-31 SSH | Login Expirado</title>
...
<br>
<br><br>
<center><b> © <script>document.write(new Date().getFullYear())</script> | <b>Direitos Reservados a</b> <a href=" " target="_blank" class="text-info m-l-5"><b> Couty SSH</b></a><b></b></center>
</section>
    </form>
...
<footer class="footer footer-static footer-light">
    <center><p class="clearfix blue-grey lighten-2 mb-0">
        <span class="center">
			<center> © <script>document.write(new Date().getFullYear())</script> | <i class="fa fas-linux"></i><a href="http://coutyssh.online/" target="_blank" class="text-info m-l-5"><b> VPS WEB V.31</b></a><br>TODOS DIREITOS RESERVADOS</center>
        </span>
